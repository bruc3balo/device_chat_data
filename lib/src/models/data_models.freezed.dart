...
class _$ErrorImpl<T> implements Error<T> {
  const _$ErrorImpl({required this.errorMessage, this.stackTrace});
  ...
  @override
  String toString() {
    return 'Result<$T>.error(errorMessage: $errorMessage, stackTrace: $stackTrace)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(errorMessage, stackTrace);
  }
